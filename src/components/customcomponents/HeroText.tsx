...
export const HeroText = () => {
  ...
  return (
    <div className="flex flex-col items-center sm:w-[100%] md:w-[50%] lg:w-[75%] xl:w-auto">
      <h1 className="font-extrabold text-neutral-200 lg:text-6xl xl:text-8xl text-2xl text-center">
        {"Plan your trip based on"}
      </h1>
      <div className="md:px-20 py-3">
        <TypeWriter />
      </div>
      <p className="w-full md:w-[75%] xl:w-full text-center text-md md:text-xl m-2">
